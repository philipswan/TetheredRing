...
export function applyCapturePreset(guidParamWithUnits, guidParam, gui, nonGUIParams) {
  ...
  switch (0) {
    ...
    case 5:
      ...
      break
    case 6:
      multipleRings(guidParamWithUnits, nonGUIParams)
      break
    case 6.5:
      multipleUSRings(guidParamWithUnits, nonGUIParams)
      break
    case 7:
  ...
  function bigIslandLauncher() {
    ...
    guidParamWithUnits['numVirtualLaunchSleds'].value = 1
    guidParamWithUnits['launcherMassDriver1InitialVelocity'].value = 2
    guidParamWithUnits['launcherMassDriver2InitialVelocity'].value = 1000
    guidParamWithUnits['launcherMassDriverScrewThreadStarts'].value = 8  // m
