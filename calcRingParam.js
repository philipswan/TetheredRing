function CalculateRingParameters() {
  ...
  Cx =
    P1x +
    (M23xy * F23y - M23xz * F23z) / (M23xy ^ (2 + M23yz) ^ (2 + M23xz) ^ 2);
  Cy =
    P1y +
    (M23yz * F23z - M23xy * F23x) / (M23xy ^ (2 + M23yz) ^ (2 + M23xz) ^ 2);
  Cz =
    P1z +
    (M23xz * F23x - M23yz * F23y) / (M23xy ^ (2 + M23yz) ^ (2 + M23xz) ^ 2);
}
