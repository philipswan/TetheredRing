...
export function updateLauncherSpecs(dParamWithUnits, crv, launcher, specs) {
  ...
  const launchSledMass = dParamWithUnits['launchSledMass'].value // kg
  ...
  const launchSledAndVehicleTotalMass = launchSledMass + launchVehicleEmptyMass + launchVehiclePropellantMass + launchVehiclePayloadMass // kg
    ...
    case 'earth':
      return {
        ...
        airTemperatureInKelvinAtAltitude: function(a) {
          // From the 1976 U.S. Standard Atmosphere
          // Input in meters, Output in Kelvin
          // Generated by ChatGPT 5.2
          if (a < 11000) {
            return 288.15 - 0.0065 * a
          } else if (a < 20000) {
            return 216.65
          } else if (a < 32000) {
            return 216.65 + 0.001 * (a - 20000)
          } else if (a < 47000) {
            return 228.65 + 0.0028 * (a - 32000)
          } else if (a < 51000) {
            return 270.65
          } else if (a < 71000) {
            return 270.65 - 0.0028 * (a - 51000)
          } else if (a < 86000) {
            return 214.65 - 0.002 * (a - 71000)
          } else {
            return 186.87 // cap; above ISA validity
          }
        },
        ...
        specificGasConstantForAir: 287.058, // J/(kg·K)
        texturePath: "",
...
export function myFormat(value, fractionDigits = 0) {
