export class referenceFrame {
	constructor(curve, numZones, cameraRange, velocity, direction, trackIndex, name) {
		this.curve = curve  // This is the curve along which objects will be placed
		this.numZones = numZones  // This is the number of regions that we'll divide the entired reference frame into to do dynamic object allocation.
	...
	initialize() {
		...
		this.wedges = new Array(this.numZones).fill().map(makeEmptyArrays)
